...
class JhipsterDemoReactOpenApiKafkaCzechKafkaResourceIT {
    ...
    void setup() {
        ...
        JhipsterDemoReactOpenApiKafkaCzechKafkaResource kafkaResource = new JhipsterDemoReactOpenApiKafkaCzechKafkaResource(
            kafkaProperties
        );
    ...
    void producesMessages() throws Exception {
        restMockMvc
            .perform(post("/api/jhipster-demo-react-open-api-kafka-czech-kafka/publish/topic-produce?message=value-produce"))
    ...
    void consumesMessages() throws Exception {
        ...
        MvcResult mvcResult = restMockMvc
            .perform(get("/api/jhipster-demo-react-open-api-kafka-czech-kafka/consume?topic=topic-consume"))
            .andExpect(status().isOk())
