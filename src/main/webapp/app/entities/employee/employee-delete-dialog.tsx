...
export const EmployeeDeleteDialog = (props: RouteComponentProps<{ id: string }>) => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="jhipsterDemoReactOpenApiKafkaCzechApp.employee.delete.question">
        <Translate contentKey="jhipsterDemoReactOpenApiKafkaCzechApp.employee.delete.question" interpolate={{ id: employeeEntity.id }}>
