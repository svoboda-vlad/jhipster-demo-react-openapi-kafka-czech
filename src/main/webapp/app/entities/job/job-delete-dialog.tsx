...
export const JobDeleteDialog = (props: RouteComponentProps<{ id: string }>) => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="jhipsterDemoReactOpenApiKafkaCzechApp.job.delete.question">
        <Translate contentKey="jhipsterDemoReactOpenApiKafkaCzechApp.job.delete.question" interpolate={{ id: jobEntity.id }}>
