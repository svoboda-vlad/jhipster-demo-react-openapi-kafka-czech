  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="jhipsterDemoReactOpenApiKafkaCzechApp.jobHistory.home.createOrEditLabel" data-cy="JobHistoryCreateUpdateHeading">
            <Translate contentKey="jhipsterDemoReactOpenApiKafkaCzechApp.jobHistory.home.createOrEditLabel">
        ...
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField
                label={translate('jhipsterDemoReactOpenApiKafkaCzechApp.jobHistory.startDate')}
              ...
              />
              <ValidatedField
                label={translate('jhipsterDemoReactOpenApiKafkaCzechApp.jobHistory.endDate')}
              ...
              />
              <ValidatedField
                label={translate('jhipsterDemoReactOpenApiKafkaCzechApp.jobHistory.language')}
              ...
              >
                {languageValues.map(language => (
                  <option value={language} key={language}>
                    {translate('jhipsterDemoReactOpenApiKafkaCzechApp.Language.' + language)}
                  </option>
                ))}
              </ValidatedField>
              <ValidatedField
                ...
                name="job"
                data-cy="job"
                label={translate('jhipsterDemoReactOpenApiKafkaCzechApp.jobHistory.job')}
                type="select"
              >
                <option value="" key="0" />
                {jobs
              ...
              <ValidatedField
                ...
                name="department"
                data-cy="department"
                label={translate('jhipsterDemoReactOpenApiKafkaCzechApp.jobHistory.department')}
                type="select"
              >
                <option value="" key="0" />
                {departments
              ...
              <ValidatedField
                ...
                name="employee"
                data-cy="employee"
                label={translate('jhipsterDemoReactOpenApiKafkaCzechApp.jobHistory.employee')}
                type="select"
              >
                <option value="" key="0" />
                {employees
