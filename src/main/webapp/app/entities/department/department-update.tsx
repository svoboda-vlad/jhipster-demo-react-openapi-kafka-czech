  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="jhipsterDemoReactOpenApiKafkaCzechApp.department.home.createOrEditLabel" data-cy="DepartmentCreateUpdateHeading">
            <Translate contentKey="jhipsterDemoReactOpenApiKafkaCzechApp.department.home.createOrEditLabel">
        ...
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField
                label={translate('jhipsterDemoReactOpenApiKafkaCzechApp.department.departmentName')}
              ...
              <ValidatedField
                ...
                name="location"
                data-cy="location"
                label={translate('jhipsterDemoReactOpenApiKafkaCzechApp.department.location')}
                type="select"
              >
                <option value="" key="0" />
                {locations
