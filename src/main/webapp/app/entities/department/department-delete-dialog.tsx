...
export const DepartmentDeleteDialog = (props: RouteComponentProps<{ id: string }>) => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="jhipsterDemoReactOpenApiKafkaCzechApp.department.delete.question">
        <Translate contentKey="jhipsterDemoReactOpenApiKafkaCzechApp.department.delete.question" interpolate={{ id: departmentEntity.id }}>
