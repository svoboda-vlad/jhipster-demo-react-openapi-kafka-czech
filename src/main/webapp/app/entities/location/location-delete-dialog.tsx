...
export const LocationDeleteDialog = (props: RouteComponentProps<{ id: string }>) => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="jhipsterDemoReactOpenApiKafkaCzechApp.location.delete.question">
        <Translate contentKey="jhipsterDemoReactOpenApiKafkaCzechApp.location.delete.question" interpolate={{ id: locationEntity.id }}>
