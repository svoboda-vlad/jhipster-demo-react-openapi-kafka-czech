  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="jhipsterDemoReactOpenApiKafkaCzechApp.location.home.createOrEditLabel" data-cy="LocationCreateUpdateHeading">
            <Translate contentKey="jhipsterDemoReactOpenApiKafkaCzechApp.location.home.createOrEditLabel">
        ...
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField
                label={translate('jhipsterDemoReactOpenApiKafkaCzechApp.location.streetAddress')}
              ...
              />
              <ValidatedField
                label={translate('jhipsterDemoReactOpenApiKafkaCzechApp.location.postalCode')}
              ...
              />
              <ValidatedField
                label={translate('jhipsterDemoReactOpenApiKafkaCzechApp.location.city')}
                id="location-city"
                name="city"
                data-cy="city"
                type="text"
              />
              <ValidatedField
                label={translate('jhipsterDemoReactOpenApiKafkaCzechApp.location.stateProvince')}
              ...
              <ValidatedField
                ...
                name="country"
                data-cy="country"
                label={translate('jhipsterDemoReactOpenApiKafkaCzechApp.location.country')}
                type="select"
              >
                <option value="" key="0" />
                {countries
