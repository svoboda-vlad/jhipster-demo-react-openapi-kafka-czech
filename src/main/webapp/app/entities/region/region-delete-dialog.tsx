...
export const RegionDeleteDialog = (props: RouteComponentProps<{ id: string }>) => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="jhipsterDemoReactOpenApiKafkaCzechApp.region.delete.question">
        <Translate contentKey="jhipsterDemoReactOpenApiKafkaCzechApp.region.delete.question" interpolate={{ id: regionEntity.id }}>
