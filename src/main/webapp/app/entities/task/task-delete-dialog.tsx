...
export const TaskDeleteDialog = (props: RouteComponentProps<{ id: string }>) => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="jhipsterDemoReactOpenApiKafkaCzechApp.task.delete.question">
        <Translate contentKey="jhipsterDemoReactOpenApiKafkaCzechApp.task.delete.question" interpolate={{ id: taskEntity.id }}>
