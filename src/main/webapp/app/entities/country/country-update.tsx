  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="jhipsterDemoReactOpenApiKafkaCzechApp.country.home.createOrEditLabel" data-cy="CountryCreateUpdateHeading">
            <Translate contentKey="jhipsterDemoReactOpenApiKafkaCzechApp.country.home.createOrEditLabel">
        ...
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField
                label={translate('jhipsterDemoReactOpenApiKafkaCzechApp.country.countryName')}
              ...
              <ValidatedField
                ...
                name="region"
                data-cy="region"
                label={translate('jhipsterDemoReactOpenApiKafkaCzechApp.country.region')}
                type="select"
              >
                <option value="" key="0" />
                {regions
