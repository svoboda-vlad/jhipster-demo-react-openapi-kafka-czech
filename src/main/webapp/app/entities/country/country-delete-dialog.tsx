...
export const CountryDeleteDialog = (props: RouteComponentProps<{ id: string }>) => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="jhipsterDemoReactOpenApiKafkaCzechApp.country.delete.question">
        <Translate contentKey="jhipsterDemoReactOpenApiKafkaCzechApp.country.delete.question" interpolate={{ id: countryEntity.id }}>
