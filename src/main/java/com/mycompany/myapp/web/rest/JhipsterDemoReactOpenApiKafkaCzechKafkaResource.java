...
@RestController
@RequestMapping("/api/jhipster-demo-react-open-api-kafka-czech-kafka")
public class JhipsterDemoReactOpenApiKafkaCzechKafkaResource {

    private final Logger log = LoggerFactory.getLogger(JhipsterDemoReactOpenApiKafkaCzechKafkaResource.class);

    private final KafkaProperties kafkaProperties;
    private KafkaProducer<String, String> producer;
    private ExecutorService sseExecutorService = Executors.newCachedThreadPool();

    public JhipsterDemoReactOpenApiKafkaCzechKafkaResource(KafkaProperties kafkaProperties) {
